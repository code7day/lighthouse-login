...
use Zedu\IwsGraphqlLogin\Providers\IwsGraphqlLoginServiceProvider;
...
class TestCase extends Orchestra
{
    ...
    protected function getPackageProviders($app)
    {
        return [
            ...
            IwsGraphqlLoginServiceProvider::class,
        ];
    }
    ...
    public function createClient()
    {
        ...
        config()->set('iws-graphql-login.client_id', $client->id);
        config()->set('iws-graphql-login.client_secret', $client->secret);
    }
